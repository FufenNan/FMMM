...
class Text2MotionDataset(data.Dataset):
    def __init__(self, dataset_name, is_test, w_vectorizer, feat_bias = 5, max_text_len = 20, unit_length = 4, shuffle=True):
        ...
        if is_test:
            split_file = pjoin(self.data_root, 'recaption_test.txt')
        else:
            split_file = pjoin(self.data_root, 'recaption_val.txt')
    ...
    def __getitem__(self, item):
        ...
        return word_embeddings, pos_one_hots, caption, sent_len, motion, m_length, '_'.join(tokens), name, recaption
